...
all:
	...
	@$(MAKE) CURR_LANGUAGE=$(LANG_ENGLISH) CURR_MODE=$(MODE_PROFESSOR)

	@$(MAKE) CURR_LANGUAGE=$(LANG_SPANISH) CURR_MODE=$(MODE_DEV)
	@$(MAKE) CURR_LANGUAGE=$(LANG_SPANISH) CURR_MODE=$(MODE_GAMEDEV)
	@$(MAKE) CURR_LANGUAGE=$(LANG_SPANISH) CURR_MODE=$(MODE_PROFESSOR)
